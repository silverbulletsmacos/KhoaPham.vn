...
<?php
  ...
  $row_tin = mysqli_fetch_array($tin, MYSQLI_ASSOC);
?>
...
<div class="clear"></div>
	<ul>
        ...
        <?php
          $tintrongloai = tincungloai($idTin, $row_tin['idLT']);
          while($row_tintrongloai = mysqli_fetch_array($tintrongloai, MYSQLI_ASSOC))
          {
        ?>
        <li>       
             <a href="index.php?p=chitiettin&idTin=<?php echo $row_tintrongloai['idTin']; ?>"><img src="upload/tintuc/<?php echo $row_tintrongloai['urlHinh']; ?>" alt="error"></a> <br />
 			 <a class="title" href="index.php?p=chitiettin&idTin=<?php echo $row_tintrongloai['idTin']; ?>"><?php echo $row_tintrongloai['TieuDe']; ?></a>
             <span class="no_wrap">   
        </li>
        <?php
          }
